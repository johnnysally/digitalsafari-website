...
const faqs = [
    ...
    },
    {
        ...
        answer: 'Open the DigitalSafari app, browse restaurants and menus, add items to your order, and complete payment.',
    },
    {
        question: 'How can my business join?',
        answer: 'Click "Become a Partner" on the website, choose your business type, and complete the registration. Our team will review and approve your account.',
    },
    {
    ...
    {
        question: 'Is DigitalSafari a travel agency?',
        answer: 'No, DigitalSafari is a technology platform connecting customers with participating businesses. We provide the digital infrastructure for discovery and transactions.',
    },
    {
        question: 'How can I contact DigitalSafari?',
        answer: 'You can reach us through the Contact page, email, or phone. Our support team is available to help.',
    },
];
